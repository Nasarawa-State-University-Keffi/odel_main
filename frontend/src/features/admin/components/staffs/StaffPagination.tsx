...
const StaffPagination = ({ currentPage, totalPages, onPageChange }: StaffPaginationProps) => {
    ...
    return (
        <div className="p-6 border-t border-border/50 bg-muted/5 flex-none overflow-x-auto">
            <Pagination>
